...
<head>
	...
	<script>
		window.onload = function(){
			...
			//함수의 이름을 넣어줄 때는 함수이름 뒤에 ()를 붙이면 안된다!!!
		...
		function validationCheck(){
			...
			//alert('유효성검사');
			//등록 요청
			regForm.action = "/book/regProcess"; //요청 URL설정
			regForm.method = "post";
			//폼을 전송 -> 새로운 페이지를 요청
			regForm.submit();
		}
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="pw" name="pw" placeholder="pw" value="pw">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="pwCheck" placeholder="pwCheck" value="pw">
                                    </div>
                                </div>
