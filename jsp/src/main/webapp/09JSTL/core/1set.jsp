...
<%@page import="com.z3un3un.dto.Person"%>
...
//페이징할 때 Map 사용 굿
//ajax, petch를 이용할 경우
//	-> 데이터만 전달 -> 스크립트에서 데이터를파싱하여 화면을 다시 그려주어야 한다
//다른 타입의 여러가지 값을 저장하기 용이
//리스트
//pageDto
...
%>
<!-- map은 변수로 선언만하고 영역에 저장하지 않았기 때문에 el문법으로 사용할 수 없다. -->
